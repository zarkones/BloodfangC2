...
```c++
auto caption_string = symbol<const char*>( "hello from bloodfang" );
...
/usr/bin/x86_64-w64-mingw32-ld: bin/bloodfang.x64.exe:.text: section below image base
-> compiling src/main.cc to main.x86.obj
-> compiling src/resolve.cc to resolve.x86.obj
compiling x86 project
/usr/bin/i686-w64-mingw32-ld: bin/bloodfang.x86.exe:.text: section below image base
$ ll bin                                                                                                                                                                                                                                                                                20:57:10
drwxr-xr-x spider spider 4.0 KB Thu Mar 13 20:57:10 2025 obj
.rw-r--r-- spider spider 752 B  Thu Mar 13 20:57:10 2025 bloodfang.x64.bin
.rw-r--r-- spider spider 672 B  Thu Mar 13 20:57:10 2025 bloodfang.x86.bin
```
...
.rw-r--r-- spider spider 1.2 KB Thu Mar 13 20:58:13 2025 bloodfang.x64.bin
.rw-r--r-- spider spider 1.1 KB Thu Mar 13 20:58:13 2025 bloodfang.x86.bin
```
